...
<body>
    <div id="main">
        ...
        <div id="parte1">
            <div id="imagens">
                <?php
                include "formConsultaImagens.php";
                ?>
            </div>
            <?php
            ...
            if(isset($pesquisar)){
                $consulta = "SELECT * FROM imagens WHERE descricao LIKE '%$pesquisar%' LIMIT 0,10";
            ...
            <div id="consultas_imagens"> 
                ...
                <table>
                    ...
                    <?php while($rows_imagens = @mysqli_fetch_array(@$resultado)){ 
                        ...
                        echo
                        "<tr><td><a href='editando_imagens.php?id=$id_imagens'><img src='./images/upload/$arquivo'></a></td>".
                        "<td>$localizacao</td>".
                        "</tr>";
